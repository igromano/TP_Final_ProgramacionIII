<%@ Page Title="Registrar" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="Registrar.aspx.cs" Inherits="ManoExperta.Registrar" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container-fluid" style="display: flex; align-items: center; justify-content: center; height: 100%; width: 100%">
        ...
        <% if (Session["crear"].Equals("usuario"))
            { %>
        ...
        <% } %>
        <% if (Session["crear"].Equals("proveedor"))
            { %>
        <form class="row g-3 needs-validation" novalidate>
            <div class="container d-flex justify-content-center align-items-center" style="height: 100vh;">
